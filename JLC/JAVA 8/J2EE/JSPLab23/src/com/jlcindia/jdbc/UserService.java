...
public class UserService {
	...
	public int verifyUser( String un, String pw){
		int x=0; Connection con=null; PreparedStatement ps=null; ResultSet rs=null;
		try{
	...
	public int registerUser(UserTo uto){
		int x=0; Connection con=null; PreparedStatement ps=null;
		try{
			con=JDBCUtil.getConnection();
	...
	String pw=null; Connection con=null; PreparedStatement ps=null; ResultSet rs=null;
	try{
		con=JDBCUtil.getConnection();
	...
	public int getNextUserId(){
		int x=100; Connection con=null; PreparedStatement ps=null; ResultSet rs=null;
		try{
			con=JDBCUtil.getConnection();
